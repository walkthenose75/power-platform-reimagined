...
| Acceptance says **Code app in solution: none** | App built but not added to the solution | `scripts/add-app-to-solution.ps1 -EnvironmentUrl <url> -SolutionUnique <name> -AppId <id>` (or portal *Add existing → App*). |
